...
/*   Updated: 2023/09/26 16:52:25 by neddy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_walls(t_game *game)
{
	...
	game->wall.textposit = (game->wall.drawStart - screenHeight / 2
		+ game->wall.lineHeight / 2) * (1.0 * IMGPX / game->wall.lineHeight);
...
{
	if (game->player.side == 0 && game->player.rayDirX > 0 && wall_texture == '1')
		paint_on_screen_by_pixel(&game->background, x, game->wall.wallY, img_px(game->wall.s_wall, game->wall.texX, game->wall.texY));
	else if (game->player.side == 0 && game->player.rayDirX < 0 && wall_texture == '1')
		paint_on_screen_by_pixel(&game->background, x, game->wall.wallY, img_px(game->wall.n_wall, game->wall.texX, game->wall.texY));
	else if (game->player.side == 1 && game->player.rayDirY < 0 && wall_texture == '1')
		paint_on_screen_by_pixel(&game->background, x, game->wall.wallY, img_px(game->wall.w_wall, game->wall.texX, game->wall.texY));
	else if (game->player.side == 1 && game->player.rayDirX > 0 && wall_texture == '1')
		paint_on_screen_by_pixel(&game->background, x, game->wall.wallY, img_px(game->wall.e_wall, game->wall.texX, game->wall.texY));
}
...
void	draw_images_to_game(t_game *game, int x)
{
	...
	init_walls(game);
	wall_texture = game->map[game->player.mapX][game->player.mapY]; //SegFault
